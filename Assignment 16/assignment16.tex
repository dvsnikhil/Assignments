...
\section*{Ex 12.3.1}
\begin{enumerate}
\item In the matrix $A=\begin{bmatrix}
2 & 5 & 19 & -7\\
25 & -2 & \frac{5}{2} & 12\\
\sqrt 3 & 1 & -5 & 17, \end{bmatrix}$, write:
...
\begin{enumerate}[label=(\roman*)]
\item $a_ij=\frac{1}{2}\mydet{-3i+j}$
\item $a_ij=2i-j$
\end{enumerate}
\item Find the values of $x, y$ and $z$ from the following equations:
\begin{enumerate}[label=(\roman*)]
\item $\begin{bmatrix}
4 & 3 \\ x & 5 \end{bmatrix} = \begin{bmatrix}
y & z \\ 1 & 5 \end{bmatrix}$
\item $\begin{bmatrix}
x+y & 2 \\ 5+z & xy \end{bmatrix}= \begin{bmatrix}
 6  & 2 \\  5  & 8  \end{bmatrix}$
\item $\begin{bmatrix}
x+y+z \\ x+z \\ y+z \end{bmatrix}= \begin{bmatrix}
9 \\ 5 \\  7 \end{bmatrix}$ 
\end{enumerate}
\item Find the value of $a, b, c$ and $d$ from the equation:
\begin{align} 
\begin{bmatrix}
a-b & 2a-c \\ 2a-b &  3c+d \end{bmatrix}=\begin{bmatrix}
-1 & 5 \\ 0 & 13 \end{bmatrix}
\end{align}
...
\begin{align}
\begin{bmatrix}
3x+7 & 5 \\ y+1 & 2-3x \end{bmatrix}, \begin{bmatrix}
0 & y-2 \\ 8 & 4 \end{bmatrix}
\end{align}
\begin{enumerate}
\item $x=\frac{-1}{3}, y=7$
