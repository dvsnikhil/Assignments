...
\maketitle
\section*{Ex 11.11.1}
In each of the following \ref{subsection:1-5}, find the equation of the circle with:
...
\end{enumerate}
In each of the following \ref{subsection:6-9}, find the centre and radius of the circles
\subsection{Exercise 6-9}
\label{subsection:6-9}
